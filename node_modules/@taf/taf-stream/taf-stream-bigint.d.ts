...
export interface TafClass<T = any> {
  toObject (): T;
  readFromObject (json: T): void
}

export type ToObject<T> = (
  T extends boolean | number | string | Buffer | bigint ? T :
  T extends TafClass<infer U> ? U :
  never
)

export interface HeroList<T> extends TafClass<ToObject<T> extends never ? never : ToObject<T>[]> {
  readonly value: T[]
...
export interface MultiMap<Key, Value> extends TafClass<never> {
  readonly keys: any
  readonly value: any
...
export interface HeroMap<Key, Value> extends TafClass<ToObject<Value> extends never ? never : Record<string, ToObject<Value>>> {
...
export interface ListConstructor {
  ...
  (proto: ConstructorOf<string>, bValue: Truthy): ConstructorOf<HeroList<Buffer>>
  (proto: typeof Int64, bValue: Truthy): ConstructorOf<HeroList<string>>
  (proto: typeof Int64, bValue: 2): ConstructorOf<HeroList<bigint>>
  new <T>(proto: ConstructorOf<T>): HeroList<T>
  new (proto: ConstructorOf<string>, bValue: Truthy): HeroList<Buffer>
  new (proto: typeof Int64, bValue: Truthy): HeroList<string>
  new (proto: typeof Int64, bValue: 2): HeroList<bigint>
}

export const List: ListConstructor

export type Map<Key, Value> = (
  Key extends string | number | Buffer | bigint
    ? HeroMap<Key, Value>
    : MultiMap<Key, Value>
)
...
export interface MapConstructor {
  ...
  <Value>(kproto: typeof Int64, vproto: ConstructorOf<Value>, bKey: 2): ConstructorOf<Map<bigint, Value>>
  ...
  <Key>(kproto: ConstructorOf<Key>, vproto: typeof Int64, bKey: Falsy, bValue: 2): ConstructorOf<Map<Key, bigint>>
  ...
  (kproto: typeof String, vproto: typeof Int64, bKey: Truthy, bValue: 2): ConstructorOf<Map<Buffer, bigint>>
  (kproto: typeof Int64, vproto: typeof String, bKey: Truthy, bValue: Truthy): ConstructorOf<Map<string, Buffer>>
  (kproto: typeof Int64, vproto: typeof String, bKey: 2, bValue: Truthy): ConstructorOf<Map<bigint, Buffer>>
  (kproto: typeof Int64, vproto: typeof Int64, bKey: Truthy, bValue: Truthy): ConstructorOf<Map<string, string>>
  (kproto: typeof Int64, vproto: typeof Int64, bKey: 2, bValue: 2): ConstructorOf<Map<bigint, bigint>>
  ...
  new <Value>(kproto: typeof Int64, vproto: ConstructorOf<Value>, bKey: 2): Map<bigint, Value>
  ...
  new <Key>(kproto: ConstructorOf<Key>, vproto: typeof Int64, bKey: Falsy, bValue: 2): Map<Key, bigint>
  ...
  new (kproto: typeof String, vproto: typeof Int64, bKey: Truthy, bValue: 2): Map<Buffer, bigint>
  new (kproto: typeof Int64, vproto: typeof String, bKey: Truthy, bValue: Truthy): Map<string, Buffer>
  new (kproto: typeof Int64, vproto: typeof String, bKey: 2, bValue: Truthy): Map<bigint, Buffer>
  new (kproto: typeof Int64, vproto: typeof Int64, bKey: Truthy, bValue: Truthy): Map<string, string>
  new (kproto: typeof Int64, vproto: typeof Int64, bKey: 2, bValue: 2): Map<bigint, bigint>
}

export const Map: MapConstructor

export class BinBuffer implements TafClass<Buffer> {
  ...
  writeInt64 (value: bigint, bString: 2): void
...
export class JceOutputStream {
  ...
  writeInt64 (tag: number, value: bigint, bString: 2): void
...
export class JceInputStream {
  ...
  readInt64 (tag: number, require: boolean, DEFAULT_VALUE: bigint | undefined, bString: 2): bigint
...
export class UniAttribute {
  static WUP_VERSION: 2
  static JSON_VERSION: 9
  // static WUP_SIMPLE: 3
  ...
  writeInt64 (name: string, value: bigint, bString: 2): void
  ...
  readInt64 (name: string, DEFAULT_VALUE: bigint | undefined, bString: 2): bigint
...
export class Wup {
  ...
  get<T>(key: string, TYPE_T: ConstructorOf<T>, DEFAULT_VALUE: any) : T;

  getTafResultCode (): number
  getTafResultDesc (): string
  ...
  readInt64 (name: string, DEFAULT_VALUE?: number, bString?: Falsy): number
  readInt64 (name: string, DEFAULT_VALUE: string | undefined, bString: Truthy): string
  readInt64 (name: string, DEFAULT_VALUE: bigint | undefined, bString: 2): string
  readUInt8 (name: string, DEFAULT_VALUE?: number) : number
  readUInt16 (name: string, DEFAULT_VALUE?: number): number
  readUInt32 (name: string, DEFAULT_VALUE?: number): number
  readFloat (name: string, DEFAULT_VALUE?: number): number
