...
import { Config } from '@taf/taf-utils'
import { DyeingObject } from '@taf/taf-dyeing'
import { DateFormat, Formatter } from '@taf/taf-winston'

type LogType = 'TafRotate' | 'TafDate' | 'TafRemote'
...
declare class TafLogs {
  constructor (type: LogType, name?: string, options?: TafLogsOptions)
