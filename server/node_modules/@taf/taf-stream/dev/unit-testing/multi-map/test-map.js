...
function test_map() {
    ...
    var m = new Taf.Map(Taf.String, StatF.taf.StatMicMsgBody);
    ...
    var ta = tt.readMap(1, true, Taf.Map(Taf.String, StatF.taf.StatMicMsgBody));
    ...
    //根据值去获取
    var body = ta.get(StatMicMsgHead2);
    if (body == undefined) {
