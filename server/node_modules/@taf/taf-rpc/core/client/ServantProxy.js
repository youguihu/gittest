 ...
 * 2014-10-28
 */
var Promise      = require("@taf/taf-utils").Promise;
...
ServantProxy.prototype.setPushCallbacks = function (callback) { //设置回调消息
    this._worker.setPushCallback(callback);
};
...
ServantProxy.prototype.rpc_call = function ($RequestId, $FuncName, $AppBuffer) {
    ...
    // reqMessage.request.sBuffer = $AppBuffer;
    // reqMessage.request.sBuffer = args;
